...
class UnifiedCompositeExchange(ABC):
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            # Cleanup on failure
            await self.close()
            raise ExchangeRestError(f"Exchange initialization failed: {e}")
    ...
    async def close(self) -> None:
        ...
        try:
            ...
            raise ExchangeRestError(f"Close failed: {e}")
    ...
    async def _initialize_rest_clients(self) -> None:
        ...
        try:
            ...
            raise ExchangeRestError(f"REST client initialization failed: {e}")
    ...
    async def _initialize_websocket_clients(self) -> None:
        ...
        try:
            ...
            self.logger.error("Failed to initialize WebSocket clients", 
                            exchange=self.exchange_name, error=str(e))
            raise ExchangeRestError(f"WebSocket client initialization failed: {e}")
    ...
    async def _start_websocket_streams(self) -> None:
        ...
        try:
            ...
            self.logger.error("Failed to initialize WebSocket streams", 
                            exchange=self.exchange_name, error=str(e))
            raise ExchangeRestError(f"WebSocket stream initialization failed: {e}")
