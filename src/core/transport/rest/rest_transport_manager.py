...
from ...exceptions.exchange import BaseExchangeError, RateLimitErrorBase, ExchangeConnectionError
...
class RestTransportManager:
    ...
    async def _execute_with_retry(
        ...
        for attempt in range(1, max_attempts + 1):
            ...
            except RateLimitErrorBase as e:
                if not retry_strategy.should_retry(attempt, e) or attempt == max_attempts:
                    raise
        ...
        raise ExchangeConnectionError(500, "Maximum retry attempts exceeded")
