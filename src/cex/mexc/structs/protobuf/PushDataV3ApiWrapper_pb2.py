...
try:
    ...
    try:
        from src.cex.mexc_api.websocket import PrivateAccountV3Api_pb2 as PrivateAccountV3Api__pb2
        from src.cex.mexc_api.websocket import PrivateDealsV3Api_pb2 as PrivateDealsV3Api__pb2
        from src.cex.mexc_api.websocket import PrivateOrdersV3Api_pb2 as PrivateOrdersV3Api__pb2
        from src.cex.mexc_api.websocket import PublicAggreBookTickerV3Api_pb2 as PublicAggreBookTickerV3Api__pb2
        from src.cex.mexc_api.websocket import PublicAggreDealsV3Api_pb2 as PublicAggreDealsV3Api__pb2
        from src.cex.mexc_api.websocket import PublicAggreDepthsV3Api_pb2 as PublicAggreDepthsV3Api__pb2
        from src.cex.mexc_api.websocket import PublicBookTickerBatchV3Api_pb2 as PublicBookTickerBatchV3Api__pb2
        from src.cex.mexc_api.websocket import PublicBookTickerV3Api_pb2 as PublicBookTickerV3Api__pb2
        from src.cex.mexc_api.websocket import PublicDealsV3Api_pb2 as PublicDealsV3Api__pb2
        from src.cex.mexc_api.websocket import (
            PublicIncreaseDepthsBatchV3Api_pb2 as PublicIncreaseDepthsBatchV3Api__pb2,
        )
        from src.cex.mexc_api.websocket import PublicIncreaseDepthsV3Api_pb2 as PublicIncreaseDepthsV3Api__pb2
        from src.cex.mexc_api.websocket import PublicLimitDepthsV3Api_pb2 as PublicLimitDepthsV3Api__pb2
        from src.cex.mexc_api.websocket import PublicMiniTickersV3Api_pb2 as PublicMiniTickersV3Api__pb2
        from src.cex.mexc_api.websocket import PublicMiniTickerV3Api_pb2 as PublicMiniTickerV3Api__pb2
        from src.cex.mexc_api.websocket import PublicSpotKlineV3Api_pb2 as PublicSpotKlineV3Api__pb2
    except ImportError:
