...
# TODO: remove use direct GateioSpotSymbol.to_pair
def from_symbol(symbol):
    """Convert Symbol to Gate.io pair string."""
    return GateioSpotSymbol.to_pair(symbol)

# TODO: remove  use GateioFuturesSymbol.to_symbol(contract_str)
...
# TODO: remove  use GateioFuturesSymbol.to_pair(contract_str)
