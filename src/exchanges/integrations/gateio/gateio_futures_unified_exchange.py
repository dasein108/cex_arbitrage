...
class GateioFuturesUnifiedExchange(UnifiedCompositeExchange):
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            raise BaseExchangeError(f"Initialization failed: {e}")
    ...
    async def close(self) -> None:
        ...
        try:
            ...
            raise BaseExchangeError(f"Shutdown failed: {e}")
    ...
    async def _initialize_rest_clients(self) -> None:
        ...
        try:
            ...
            raise BaseExchangeError(f"REST initialization failed: {e}")
    ...
    async def _initialize_websockets(self) -> None:
        ...
        try:
            ...
            raise BaseExchangeError(f"WebSocket initialization failed: {e}")
    ...
    async def get_orderbook(self, symbol: Symbol) -> Optional[OrderBook]:
        ...
        if not self._public_rest:
            raise BaseExchangeError("Public REST client not initialized")
    ...
    async def get_balances(self) -> Dict[AssetName, AssetBalance]:
        ...
        if not self._private_rest:
            raise BaseExchangeError("Private REST client not available - check credentials")
