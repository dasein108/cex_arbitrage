...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 5, 29, 2, "", "PublicBookTickerBatchV3Api.proto"
)
...
try:
    ...
    try:
        from exchanges.integrations.mexc_api.websocket import PublicBookTickerV3Api_pb2 as PublicBookTickerV3Api__pb2
    except ImportError:
