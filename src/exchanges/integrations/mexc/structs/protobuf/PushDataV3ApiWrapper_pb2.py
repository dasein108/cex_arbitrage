...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 5, 29, 2, "", "PushDataV3ApiWrapper.proto"
)
...
try:
    ...
    try:
        from exchanges.integrations.mexc.structs.protobuf import PrivateAccountV3Api_pb2 as PrivateAccountV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import PrivateDealsV3Api_pb2 as PrivateDealsV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import PrivateOrdersV3Api_pb2 as PrivateOrdersV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import PublicAggreBookTickerV3Api_pb2 as PublicAggreBookTickerV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import PublicAggreDealsV3Api_pb2 as PublicAggreDealsV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import PublicAggreDepthsV3Api_pb2 as PublicAggreDepthsV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import PublicBookTickerBatchV3Api_pb2 as PublicBookTickerBatchV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import PublicBookTickerV3Api_pb2 as PublicBookTickerV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import PublicDealsV3Api_pb2 as PublicDealsV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import (
            PublicIncreaseDepthsBatchV3Api_pb2 as PublicIncreaseDepthsBatchV3Api__pb2,
        )
        from exchanges.integrations.mexc.structs.protobuf import PublicIncreaseDepthsV3Api_pb2 as PublicIncreaseDepthsV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import PublicLimitDepthsV3Api_pb2 as PublicLimitDepthsV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import PublicMiniTickersV3Api_pb2 as PublicMiniTickersV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import PublicMiniTickerV3Api_pb2 as PublicMiniTickerV3Api__pb2
        from exchanges.integrations.mexc.structs.protobuf import PublicSpotKlineV3Api_pb2 as PublicSpotKlineV3Api__pb2
    except ImportError:
