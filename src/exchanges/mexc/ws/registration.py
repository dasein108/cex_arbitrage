...
PublicWebSocketExchangeFactory.register(ExchangeEnum.MEXC.value, MexcWebsocketPublic)
PrivateWebSocketExchangeFactory.register(ExchangeEnum.MEXC.value, MexcWebsocketPrivate)