...
from structs.exchange import Symbol, AssetName, Order, OrderId, OrderStatus, OrderType, Side, TimeInForce, KlineInterval
...
class MexcMappings:
    ...
    def pair_to_symbol(pair_str: str) -> Symbol:
        ...
        from .mexc_symbol_mapper import MexcSymbolMapper
