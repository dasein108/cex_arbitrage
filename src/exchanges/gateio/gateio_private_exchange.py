...
from exchanges.gateio.gateio_public_exchange import GateioPublicExchange
from exchanges.gateio.rest.gateio_private import GateioPrivateExchangeSpot as GateioPrivateRest
