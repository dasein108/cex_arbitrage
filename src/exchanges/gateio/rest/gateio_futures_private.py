...
from exchanges.gateio.services.gateio_utils import GateioUtils
from exchanges.gateio.services.gateio_config import GateioConfig
from exchanges.gateio.services.gateio_config_service import GateioConfigurationService
from exchanges.gateio.services.gateio_endpoints import GateioFuturesEndpoints, GateioFuturesEndpoint
...
class GateioPrivateFuturesExchangeSpot(PrivateExchangeSpotRestInterface):
    ...
    Architecture Note: This is a private exchanges implementation that can be used
    ...
    def __init__(self, api_key: str, secret_key: str, config_service: Optional[GateioConfigurationService] = None):
        ...
        if not api_key or not secret_key:
            raise ValueError("Gate.io API credentials must be provided for private exchanges")
        ...
        self.logger.info("Initialized GATEIO_FUTURES private exchanges with authenticated RestClient")
    ...
    def _create_authenticated_headers(
        ...
        Args:
            ...
            url_path: API endpoint path (without exchanges URL)
    ...
    async def close(self):
        ...
        if hasattr(self, '_rest_client'):
            ...
            self.logger.info("Closed GATEIO_FUTURES private exchanges")
