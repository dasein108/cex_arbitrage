...
class GateioMappingConfiguration:
    """Gate.io-specific mapping configuration factory."""
    ...
    def create_mapping_configuration(cls) -> BaseMappingConfiguration:
        ...
        Returns:
            MappingConfiguration: Complete configuration for Gate.io mappings
        """
...
def create_gateio_mapping_configuration() -> BaseMappingConfiguration:
    ...
    """
    return GateioMappingConfiguration.create_mapping_configuration()