...
def get_strategy_signal(strategy_type: str, **params) -> StrategySignalInterface:
    """
    Main convenience function for getting strategy signal instances.
    ...
    return StrategySignalFactory.create_strategy(normalized_type, **params)