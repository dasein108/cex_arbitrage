...
from .implementations.volatility_harvesting_strategy_signal_v2 import VolatilityHarvestingStrategySignalV2
...
def register_all_strategies():
    ...
    # V2 aliases
    register_strategy_signal('inventory_v2', InventorySpotStrategySignalV2)
    register_strategy_signal('volatility_v2', VolatilityHarvestingStrategySignalV2)
