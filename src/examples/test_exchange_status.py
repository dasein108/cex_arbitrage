...
async def test_exchange_status(exchange_name: str = "mexc"):
    """
    ...
    try:
        ...
        init_task = asyncio.create_task(exchange.init([test_symbol]))
        ...
        if exchange._ws_client and exchange._ws_client.ws_client:
            ws_state = exchange._ws_client.ws_client.state
