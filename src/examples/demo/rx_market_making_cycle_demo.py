...
class UnifiedArbitrageDemo:
    ...
    def __init__(self,
        ...
        private_exchange.orders_stream.subscribe(lambda o:self._handle_order_update(o))
        private_exchange.balances_stream.subscribe(lambda b:self._handle_balance_update(b))
        # private_exchange.trades_stream.subscribe(self._handle_private_trade)
        ...
        # public_exchange.orderbook_stream.subscribe(self._handle_orderbook_update)
        public_exchange.book_tickers_stream.subscribe(lambda ob: self._handle_orderbook_update(ob))
        public_exchange.trades_stream.subscribe(self._handle_trade)
    ...
    async def run_demo(self) -> None:
        ...
        try:
            ...
            await self.public_exchange.wait_until_connected()
